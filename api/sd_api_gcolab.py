...
BASE_URL = "https://nonexigent-missy-jocosely.ngrok-free.dev"
...
def generate_image(user_id: int, prompt: str, style: str, num_steps: int, 
    ...
    try:
        ...
        # Enviar a API
        response = requests.post(f'{BASE_URL}/api/generatenft', json=payload)
...
def get_task_progress(task_id: str) -> dict:
    ...
    try:
        r = requests.get(f"{BASE_URL}/api/generatenft").json()
